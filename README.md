...
> **Scope:** This is *not* a VTT. It is *only* the mobile character sheet. The shared map, token movement, live sync, permissions, dice, and chat are already provided by Foundry core — Mobile Sheet does not rebuild them.
